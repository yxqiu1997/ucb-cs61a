def insert_into_all(item, nested_list):
    ...
    [[0], [0, 1, 2], [0, 3]]
    """
    return [[item] + num for num in nested_list]
...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    credit_sofar, credit_total = 0, 0

    def look_up(assignment, credit):
        nonlocal credit_sofar, credit_total
        credit_sofar, credit_total = credit_sofar + credit, credit_total + class_assignments[assignment]
        return credit_sofar / credit_total
    return look_up
    ...
    def make_counter():
        ...
        def counter(type_):
            ...
            if type_ == 'count':
                count += 1
                return count
            elif type_ == 'global-count':
                global_count += 1
                return global_count
            elif type_ == 'reset':
                count = 0
            elif type_ == 'global-reset':
                global_count = 0
